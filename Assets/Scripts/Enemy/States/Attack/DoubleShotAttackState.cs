...
{
    [System.Serializable]
    [SubclassPath("Gun", "Double Shot")]
    public class DoubleShotAttackState : AttackState
    {
        [SerializeField] private BulletSpawner _rightBulletSpawner;
        [SerializeField] private BulletSpawner _leftBulletSpawner;
        ...
        private void HandleShootingCooldown()
        {
            ...
            {
                _rightBulletSpawner.Spawn(_context.Team, _context.ForwardDirection, _bulletSpeed, _bulletLifespan, _bulletDamage);
